...
/***/ function(module, exports, __webpack_require__) {
	...
	var _configRoutes = __webpack_require__(201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsMain = __webpack_require__(202);

	var _componentsMain2 = _interopRequireDefault(_componentsMain);

	var _componentsHome = __webpack_require__(204);

	var _componentsHome2 = _interopRequireDefault(_componentsHome);

	var _componentsProfile = __webpack_require__(205);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsHelpers = __webpack_require__(213);
	...
	var Profile = _react2['default'].createClass({
	    ...
	    init: function init() {
	        ...
	        _utilsHelpers2['default'].getGithubInfos(this.props.params.username).then((function (data) {
	            this.setState({
	                bio: data.bio,
	                repos: data.repos
	            });
	    ...
	    componentDidMount: function componentDidMount() {
	        this.ref = new _firebase2['default']('https://github-note-taker-kr.firebaseio.com/');
	        this.init();
	    },
	    componentWillUnmount: function componentWillUnmount() {
	        this.unbind('notes');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
	    getGithubInfos: function getGithubInfos(username) {
	        return _axios2['default'].all([getRepos(username), getUserInfo(username)]).then(_axios2['default'].spread(function (repos, userInfo) {
	            return {
	                repos: repos.data,
	                bio: userInfo.data
	            };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function xhrAdapter(resolve, reject, config) {
	  ...
	  if (utils.isStandardBrowserEnv()) {
	    ...
	    var urlIsSameOrigin = __webpack_require__(224);
